#' It gives the test statistic value and critical value of the test TN for testing homogeneity of treatment effects against ordered alternatives in two-way ANCOVA model
#'
...
#' }
#' Res=G2
#' TN(Res,Cov,a,b,q,alpha)
#' @export
TN<-function(Res,Cov,a,b,q,alpha)
{
