#' It gives simultaneous confidence intervals for differences of successive treatment effects in two-way ANCOVA model
#'
...
#' }
#' Res=G2
#' SCI(Res,Cov,a,b,q,alpha)
#' @export
SCI<-function(Res,Cov,a,b,q,alpha)
{
